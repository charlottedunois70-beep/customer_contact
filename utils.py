...
def run_general_doc_chain(query: str):
    return st.session_state.general_doc_chain.invoke({"input": query})

def run_faq_doc_chain(query: str):
    return st.session_state.faq_doc_chain.invoke({"input": query})
