...
# ライブラリの読み込み
############################################################
from langchain_community.document_loaders import PyMuPDFLoader, Docx2txtLoader, TextLoader, CSVLoader, PyPDFLoader
...
# DBパス定義
DB_ALL_PATH = "./data/vectorstore/db_all"
DB_HR_PATH = "./data/vectorstore/db_hr"
DB_COMPANY_PATH = "./data/vectorstore/db_company"
DB_SERVICE_PATH = "./data/vectorstore/db_service"
DB_CUSTOMER_PATH = "./data/vectorstore/db_customer"
DB_GENERAL_PATH = "./data/vectorstore/db_general"
DB_FAQ_PATH = "./data/vectorstore/db_faq"

# DBの参照対象ディレクトリ
DB_NAMES = {
    DB_COMPANY_PATH: f"{RAG_TOP_FOLDER_PATH}/company",
    DB_HR_PATH: f"{RAG_TOP_FOLDER_PATH}/hr",
...
DB_NAMES = {
    ...
    DB_SERVICE_PATH: f"{RAG_TOP_FOLDER_PATH}/service",
    DB_CUSTOMER_PATH: f"{RAG_TOP_FOLDER_PATH}/customer",
    DB_GENERAL_PATH: f"{RAG_TOP_FOLDER_PATH}/general",
...
SEARCH_GENERAL_INFO_TOOL_NAME = "search_general_info"
SEARCH_GENERAL_INFO_TOOL_DESCRIPTION = "会社概要や基本方針に関する情報を検索します。"

SEARCH_FAQ_INFO_TOOL_NAME = "search_faq_info"
SEARCH_FAQ_INFO_TOOL_DESCRIPTION = "よくある質問（FAQ）に関する回答を検索します。"
